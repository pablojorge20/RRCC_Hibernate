...
public class Tmclima implements Serializable {
    ...
    @Size(max = 10)
    @Column(name = "Clima", length = 10)
    private String clima;
    @JoinColumn(name = "tmZona_id", referencedColumnName = "id", nullable = false, insertable = false, updatable = false)
    ...
    public String toString() {
        return "celepsa.rrcc.db.Tmclima[ tmclimaPK=" + tmclimaPK + " ]";
    }
