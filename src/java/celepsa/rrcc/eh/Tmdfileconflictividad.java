...
public class Tmdfileconflictividad implements Serializable {
    ...
    @Column(name = "Est")
    private Integer est;
    @JoinColumn(name = "tmFileConflictividad_id", referencedColumnName = "id", insertable = false, updatable = false)
    ...
    public String toString() {
        return "celepsa.rrcc.eh.Tmdfileconflictividad[ tmdfileconflictividadPK=" + tmdfileconflictividadPK + " ]";
    }
