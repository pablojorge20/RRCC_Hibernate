...
public class TmdfileconflictividadPK implements Serializable {
    ...
    @Basic(optional = false)
    @NotNull
    @Column(name = "tmFileConflictividad_id")
    ...
    public String toString() {
        return "celepsa.rrcc.eh.TmdfileconflictividadPK[ fechaGeneracion=" + fechaGeneracion + ", tmFileConflictividadid=" + tmFileConflictividadid + ", id=" + id + " ]";
    }
