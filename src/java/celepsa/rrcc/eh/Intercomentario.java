...
public class Intercomentario implements Serializable {
    ...
    @Column(name = "Est")
    private Integer est;
    @JoinColumn(name = "tmInterpretacion_id", referencedColumnName = "id", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    private Tminterpretacion tminterpretacion;
    @JoinColumn(name = "tmUsuario_id", referencedColumnName = "id", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    ...
    public String toString() {
        return "celepsa.rrcc.eh.Intercomentario[ intercomentarioPK=" + intercomentarioPK + " ]";
    }
