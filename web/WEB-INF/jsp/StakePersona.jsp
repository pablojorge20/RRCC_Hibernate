                            ...
                            <div class="form_description">
                                <table  border="0" cellspacing="3" cellpadding="0">
                                    <s:hidden name="persona.id" value="%{persona.id}" theme="simple"/> 
                                     <s:hidden name="persona.est" value="%{persona.est}" theme="simple"/> 
                                               ...
                                               <label class="description" for="element_5">Tipo de Documento </label><br><br>    
                                                   <label class="description" for="element_2">Nro Documento </label><br>  <br>  
                                                    ...
                                                    <td WIDTH=150>
                                                     ...
                                                     listKey="id"
                                                     listValue="Descripcion"
                                                     name="persona.tmTDocumentoid.id"
                                                     value="%{persona.tmTDocumentoid.id}"
                                                     ...
                                                     listKey="id"
                                                     listValue="Descripcion"
                                                     name="persona.tmEstadoid.id"
                                                     value="%{persona.tmEstadoid.id}"
