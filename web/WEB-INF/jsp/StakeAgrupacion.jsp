                                                        ...
                                                        <br>
                                                            ...
                                                            <br>
                                                                ...
                                                                <s:select  list="LNinfluencia"
                                                                           ...
                                                                           name="agrupacion.tmNivelInfluenciaid.id"
                                                                           value="%{agrupacion.tmNivelInfluenciaid.id}"
                                                                ...
                                                                <TD WIDTH=200>
                                                                    ...
                                                                    <br>
                                                                        ...
                                                                        <s:select  list="LZona"
                                                                                   listKey="id"
                                                                                   listValue="Descripcion"
                                                                                   name="agrupacion.tmZonaid.id"
                                                                                   value="%{agrupacion.tmZonaid.id}"
                                                                        ...
                                                                        <br>
                                                                            ...
                                                                            <s:select  list="LEstado"
                                                                                       listKey="id"
                                                                                       listValue="Descripcion"
                                                                                       name="agrupacion.tmEstadoid.id"
                                                                                       value="%{agrupacion.tmEstadoid.id}"
